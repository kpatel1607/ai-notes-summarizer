...
```json
{
  ...
  "forceUpdate": false,
  "downloadUrl": "https://lumina-ai.co.in/download-apk?v=10",
...
```text
PUBLIC_APP_VERSION_NAME=2.0.8
PUBLIC_APP_VERSION_CODE=10
```
...
```text
Backend app version: 2.0.8
Android app version: 2.0.8+10
