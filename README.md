...
```json
{
  ...
  "forceUpdate": false,
  "downloadUrl": "https://lumina-ai.co.in/download-apk?v=7",
...
```text
PUBLIC_APP_VERSION_NAME=2.0.5
PUBLIC_APP_VERSION_CODE=7
```
...
```text
Backend app version: 2.0.5
Android app version: 2.0.5+7
