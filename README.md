...
```json
{
  ...
  "forceUpdate": false,
  "downloadUrl": "https://lumina-ai.co.in/download-apk?v=9",
...
```text
PUBLIC_APP_VERSION_NAME=2.0.7
PUBLIC_APP_VERSION_CODE=9
```
...
```text
Backend app version: 2.0.7
Android app version: 2.0.7+9
